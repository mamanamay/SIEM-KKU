<script></script>
  <div class="page-container">
    <div class="page-title"><i class="ti ti-server-shield"></i> Endpoint Protection (Wazuh)</div>
    <div class="kpi-row">
      <div class="kpi" style="--kpi-color: var(--green)"><div class="kpi-label">Active Agents</div><div class="kpi-value">1</div><div class="kpi-sub">Total endpoints connected</div></div>
      <div class="kpi" style="--kpi-color: var(--blue)"><div class="kpi-label">FIM Events</div><div class="kpi-value">0</div><div class="kpi-sub">File Integrity Monitoring</div></div>
      <div class="kpi" style="--kpi-color: var(--red)"><div class="kpi-label">Rootkits Detected</div><div class="kpi-value">0</div><div class="kpi-sub">System-level threats</div></div>
    </div>
    <div class="panel">
      <p style="font-size: 11px; color: var(--text-muted);">* Wazuh endpoint integration is mocked for the demo presentation. The single agent represents this Honeypot server.</p>
    </div>
  </div>
<style>
