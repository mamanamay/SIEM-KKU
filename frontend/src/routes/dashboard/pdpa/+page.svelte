<script></script>
  <div class="page-container">
    <div class="page-title"><i class="ti ti-file-check"></i> PDPA Audit & Privacy Controls</div>
    <div class="panel">
      <table class="data-table">
        <tr><th>Policy Requirement</th><th>Status</th><th>Last Audited</th></tr>
        <tr><td>Data Encryption at Rest</td><td><span class="badge b-green">Compliant</span></td><td>Today</td></tr>
        <tr><td>Access Logging (PII)</td><td><span class="badge b-orange">Partial</span></td><td>Yesterday</td></tr>
      </table>
    </div>
  </div>
<style>
